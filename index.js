...
app.get("/", (req, res) => {
  res.render("index.ejs",{currYear: year});
...
const number2 = Math.floor(Math.random()*(size2+1));

app.post("/submit", (req, res) => {
  res.render("index.ejs",{RandomName: adj, size: len, currYear: year, no: noun, size2: len2});
